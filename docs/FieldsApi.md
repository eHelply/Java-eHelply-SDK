...
# **createField**
> CreateField200Response createField(field, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData)
...
import com.ehelply.client.api.FieldsApi;
...
# **deleteField**
> DeleteField200Response deleteField(fieldUuid, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData)
...
# **updateField**
> UpdateField200Response updateField(fieldUuid, field, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData)
