...
public class NotesApi {
     ...
     */
    public NoteDynamo createNote(NoteBase noteBase, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData) throws ApiException {
        ApiResponse<NoteDynamo> localVarResp = createNoteWithHttpInfo(noteBase, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData);
     ...
     */
    public ApiResponse<NoteDynamo> createNoteWithHttpInfo(NoteBase noteBase, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<NoteDynamo>(){}.getType();
     ...
     */
    public okhttp3.Call createNoteAsync(NoteBase noteBase, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData, final ApiCallback<NoteDynamo> _callback) throws ApiException {
     ...
     */
    public NoteDynamoHistory getNote(String noteId, Integer history, Boolean historyContent, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData) throws ApiException {
        ApiResponse<NoteDynamoHistory> localVarResp = getNoteWithHttpInfo(noteId, history, historyContent, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData);
        return localVarResp.getData();
    }
     ...
     * @param ehelplyProject  (optional)
     * @param ehelplyData  (optional)
     * @return ApiResponse&lt;NoteDynamoHistory&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<NoteDynamoHistory> getNoteWithHttpInfo(String noteId, Integer history, Boolean historyContent, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<NoteDynamoHistory>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getNoteAsync(String noteId, Integer history, Boolean historyContent, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData, final ApiCallback<NoteDynamoHistory> _callback) throws ApiException {
     ...
     */
    public NoteDynamo updateNote(String noteId, NoteBase noteBase, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData) throws ApiException {
        ApiResponse<NoteDynamo> localVarResp = updateNoteWithHttpInfo(noteId, noteBase, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NoteDynamo> updateNoteWithHttpInfo(String noteId, NoteBase noteBase, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData) throws ApiException {
     ...
     */
    public okhttp3.Call updateNoteAsync(String noteId, NoteBase noteBase, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData, final ApiCallback<NoteDynamo> _callback) throws ApiException {
