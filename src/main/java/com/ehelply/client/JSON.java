...
public class JSON {
...

    {
        gson = createGson()
            ...
            .registerTypeAdapterFactory(new com.ehelply.client.model.DetailedMetaGet.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.ehelply.client.model.MetaGet.CustomTypeAdapterFactory())
