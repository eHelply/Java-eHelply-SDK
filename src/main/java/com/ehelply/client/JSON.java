...
public class JSON {
...

    {
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.ehelply.client.model.GetServicesWithSpecs403Response.CustomTypeAdapterFactory());
        ...
        gsonBuilder.registerTypeAdapterFactory(new com.ehelply.client.model.NoteDynamoHistory.CustomTypeAdapterFactory());
