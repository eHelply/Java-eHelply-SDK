...
public class CompaniesApi {
    ...
    /**
     * Build call for deleteCompanyPlacesCompaniesCompanyUuidDelete
     ...
     */
    public okhttp3.Call deleteCompanyPlacesCompaniesCompanyUuidDeleteCall(String companyUuid, Boolean softDelete, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteCompanyPlacesCompaniesCompanyUuidDeleteValidateBeforeCall(String companyUuid, Boolean softDelete, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'companyUuid' is set
        if (companyUuid == null) {
            throw new ApiException("Missing the required parameter 'companyUuid' when calling deleteCompanyPlacesCompaniesCompanyUuidDelete(Async)");
        }
        

        okhttp3.Call localVarCall = deleteCompanyPlacesCompaniesCompanyUuidDeleteCall(companyUuid, softDelete, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData, _callback);
        return localVarCall;
     ...
     */
    public Object deleteCompanyPlacesCompaniesCompanyUuidDelete(String companyUuid, Boolean softDelete, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData) throws ApiException {
        ApiResponse<Object> localVarResp = deleteCompanyPlacesCompaniesCompanyUuidDeleteWithHttpInfo(companyUuid, softDelete, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> deleteCompanyPlacesCompaniesCompanyUuidDeleteWithHttpInfo(String companyUuid, Boolean softDelete, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData) throws ApiException {
        okhttp3.Call localVarCall = deleteCompanyPlacesCompaniesCompanyUuidDeleteValidateBeforeCall(companyUuid, softDelete, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData, null);
     ...
     */
    public okhttp3.Call deleteCompanyPlacesCompaniesCompanyUuidDeleteAsync(String companyUuid, Boolean softDelete, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteCompanyPlacesCompaniesCompanyUuidDeleteValidateBeforeCall(companyUuid, softDelete, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
