...
import com.ehelply.client.model.CreateNoteResponse;
...
public class NotesApi {
     ...
     */
    public CreateNoteResponse createNote(NoteBase noteBase, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData) throws ApiException {
        ApiResponse<CreateNoteResponse> localVarResp = createNoteWithHttpInfo(noteBase, xAccessToken, xSecretToken, authorization, ehelplyActiveParticipant, ehelplyProject, ehelplyData);
     ...
     * @param ehelplyProject  (optional)
     * @param ehelplyData  (optional)
     * @return ApiResponse&lt;CreateNoteResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<CreateNoteResponse> createNoteWithHttpInfo(NoteBase noteBase, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<CreateNoteResponse>(){}.getType();
     ...
     */
    public okhttp3.Call createNoteAsync(NoteBase noteBase, String xAccessToken, String xSecretToken, String authorization, String ehelplyActiveParticipant, String ehelplyProject, String ehelplyData, final ApiCallback<CreateNoteResponse> _callback) throws ApiException {
